<div>
    <div class="container">
        <h1 class="text-3xl text-center pb-8 pt-2">Tipos de pago</h1>
        ...
        <div class="px-6 py-4 flex ">
            ...
            <a href="{{route('admin.payments.create')}}" class="btn btn-danger ml-2">Agregar nuevo tipo de pago</a>
        </div>
                        ...
                        @foreach ($payments as $payment)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">    
                                    <div class="text-base font-medium text-gray-900"><p> {{$payment->id}}</p></div>
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap">    
                                    <div class="text-base font-medium text-gray-900">
                                        <a href="#" class="bg-gray-200"> {{$payment->name}}</a>  
                                    </div>
                                </td>
                                
                               
                                <td width="10px" class="text-center px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a  href="{{route('admin.payments.edit', $payment)}}" class="text-gray-500 cursor-pointer" ><i class="fas fa-edit text-2xl"></i></a>
                                </td>
