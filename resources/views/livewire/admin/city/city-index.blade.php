<div>
    <div class="container">
        <h1 class="text-3xl text-center pb-8 pt-2">Ciudades</h1>
        ...
        <div class="px-6 py-4 flex ">
            <input wire:keydown="limpiar_page" wire:model="search" class="flex-1 form-group h-10 w-full border-gray-300  border-2"  placeholder="Ingrese el nombre de una ciudad...">
            <a href="{{route('admin.cities.create')}}" class="btn btn-danger ml-2">Agregar nueva ciudad</a>
        </div>
                        ...
                        @foreach ($cities as $city)
                            <tr>
                                ...
                                <td width="10px" class="text-center px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a  href="{{route('admin.cities.edit', $city)}}" class="text-gray-500 cursor-pointer" ><i class="fas fa-edit text-2xl"></i></a>
                                </td>
