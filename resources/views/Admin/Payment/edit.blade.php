<x-app-layout>
    <div class="container py-8 ">
        <div class="card">
            <div class="card-body">
                <h1 class="text-2xl font-bold text-center">Editar tipo de pago</h1>   
                ...
                <div class="flex justify-between">
                    <a href="{{route('admin.payments.index')}}" class="btn btn-danger cursor-pointer" href="">Cancelar</a>
                    {!! Form::submit('Editar tipo', ['class' => 'btn btn-primary cursor-pointer']) !!}
                </div>
